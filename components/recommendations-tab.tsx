    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Enter a student ID to view personalized recommendations</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          {data.recommendations && data.recommendations.length > 0 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>Suggested interventions based on student data</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          {data.next_steps && data.next_steps.length > 0 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>Action items to support this student</CardDescription>
              </CardHeader>
              <CardContent>
